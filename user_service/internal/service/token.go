...
func (s *AuthService) generateToken(userID int64, role string, tokenType repository.TokenType, ttl time.Duration) (string, time.Time, error) {
...
func (s *AuthService) parseToken(raw string, expectedType repository.TokenType) (*tokenClaims, error) {
	if raw == "" {
