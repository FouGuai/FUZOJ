...
func LeaderboardFrozenHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewLeaderboardFrozenLogic(r.Context(), svcCtx)
		resp, err := l.LeaderboardFrozen(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
