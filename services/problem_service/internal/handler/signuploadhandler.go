...
func SignUploadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SignPartsRequest
		if err := httpx.Parse(r, &req); err != nil {
			writeError(w, r, badRequestError())
			return
		}

		l := logic.NewSignUploadLogic(r.Context(), svcCtx)
		resp, err := l.SignUpload(&req)
		if err != nil {
			writeError(w, r, err)
		} else {
